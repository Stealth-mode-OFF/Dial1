...
- Denní check-in energie a nálady
- Přehled dnešních hovorů
- Performance metriky

### 2. Pipedrive Integrace
- Automatická synchronizace kontaktů s aktivitami na dnešek
- Historie volaných kontaktů
- Chytré filtrování leadů

### 3. AI Call Screen
- **AI Research**: Automatická analýza kontaktu (odvětví, signály, personality type)
- **Speech-to-Text**: Přepis hovoru v reálném čase
- **Battle Cards**: Dynamické tipy podle typu osobnosti
- **BANT Framework**: Kvalifikace leads (Budget, Authority, Need, Timeline)
- **Win Probability**: AI predikce úspěšnosti
- **Low Energy Mode**: Automatický draft e-mailu místo hovoru

### 4. Inteligentní Caching
- AI data se ukládají permanentně do KV store
- Žádné opakované volání OpenAI API pro stejný kontakt
- Okamžité načtení cached analýz

### 5. Analytics
- Grafy výkonu (hovory, úspěšnost, conversion)
- Call log historie
- Win rate tracking
...
- `/supabase/functions/server/index.tsx` - API documentation (inline)
