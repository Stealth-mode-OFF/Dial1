 ...
 * MainLayout
 *
 * Provides the main app shell: sidebar navigation, header, and content area.
 * All main screens are rendered as children.
 *
 * For handover: This is the root layout for all dashboard pages.
 */
